...
const ELEMENT_DATA: any[] = [
  { empNo: 480331, company: 'INFSYS', completedOn: '12-5-2020',completedBy: '12-5-2020', location: 'Bangalore', status: 'Submitted', action: 'edit', ambitRequestNo: 2 },
  { empNo: 480331, company: 'INFSYS', completedOn:'12-5-2020',completedBy: '12-5-2020', location: 'Bangalore', status: 'Submitted', action: 'edit', ambitRequestNo: 4 },
  { empNo: 480331, company: 'INFSYS', completedOn:'12-5-2020',completedBy: '12-5-2020', location: 'Bangalore', status: 'Submitted', action: 'edit', ambitRequestNo: 3 },
  { empNo: 480331, company: 'INFSYS', completedOn: '12-5-2020',completedBy: '12-5-2020', location: 'Bangalore', status: 'Submitted', action: 'edit', ambitRequestNo: 2 }
...
export class PrintStatusComponent implements OnInit {
  ...
  p: number = 1;
  displayedColumns: string[] = ['select', 'empNo', 'ambitRequestNo', 'location', 'company', 'status', 'completedOn', 'completedBy', 'action'];
